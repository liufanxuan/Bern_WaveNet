...
class SR_UnetGAN():
    def __init__(self):
        ...
        self.save_dir = '/media/data/fanxuan/result/FCN_multi_test'
    ...
    def build_generator(self):
        with mirrored_strategy.scope():
            ...
            model.compile(loss="mse", optimizer=self.common_optimizer, distribute=mirrored_strategy)
        return model
    ...
    def train(self):
        ...
        self.generator.fit(data_generator)
        ...
        for epoch in range(1, self.epochs+1):
            ...
            # number_of_batches
                ...
                #g_losses = mirrored_strategy.run(self.generator.train_on_batch, (x_batch, y_batch))
                #g_loss = mirrored_strategy.reduce(tf.distribute.ReduceOp.SUM  , g_losses, axis=None)
...
if __name__ == '__main__':
    ...
    gan = SR_UnetGAN()
    #print('Strategy:', gan.generator._distribution_strategy)
    # gan.generator.distribute_reduction_method = tf.distribute.ReduceOp.SUM
    gan.train()