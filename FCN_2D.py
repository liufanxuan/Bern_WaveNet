...
class SR_UnetGAN():
    def __init__(self):
        #self.data_path = '/media/data/fanxuan/data/PART2_h5data/data_wave_50_bior3_7.h5'
        self.data_path = '/media/data/fanxuan/data/PART2_h5data/data_wave_10_haar_last.h5'
        self.save_dir = '/media/data/fanxuan/result/FCN_10_wave_mw_haar/2.0'
        #self.img_shape = (4,176,176)
        self.img_shape = (176,176,4) 
    ...
    def build_generator(self):
        model = unet_mw_2d_2(self.img_shape)
        model.summary()
        return model
