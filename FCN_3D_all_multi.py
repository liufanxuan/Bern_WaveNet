...
class SR_UnetGAN():
    def __init__(self):
        ...
        self.save_dir = '/media/data/fanxuan/result/FCN_multi_4_test'
        self.model_path = '/media/data/fanxuan/result/FCN_multi_3/model/generator_epoch_26.hdf5'
    ...
    def train(self):
        #self.generator.load_weights('/media/data/fanxuan/result/FCN_multi_3/model/generator_epoch_4.hdf5')
        ...
        with tf.Session(graph=tf.get_default_graph(), config=config) as sess:
            ...
            self.generator.load_weights('/media/data/fanxuan/result/FCN_multi_4/model/generator_epoch_26.hdf5')
            ...
            for epoch in range(1, self.epochs+1):
                ...
                val_losses = []
                for ind in range(int(len(valid_filenames)*6 / self.batch_size)):
