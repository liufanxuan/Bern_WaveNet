	...
	def generate_result_4channel(self):
		if 1:
			if 1:
				...
				save_dir = '/media/data/fanxuan/result/FCN_50_5level'
				model_path = os.path.join(save_dir, 'model/generator_epoch_100.hdf5') 
				save_path = os.path.join(save_dir, 'test_100')
