...
class SR_UnetGAN():
    def __init__(self):
        ...
        self.save_dir = '/media/data/fanxuan/result/FCN_all_wave_multi'
        ...
        with tf.Session(graph=tf.get_default_graph(), config=config) as sess:
            ...
            for epoch in range(1, self.epochs+1):
                ...
                # number_of_batches
                    ...
                    if epoch < 80:
                        [g_loss, g_loss1, g_loss2] = self.generator.train_on_batch(x1_batch,[x2_batch, x2_batch])
                    elif epoch < 200:
                        [g_loss, g_loss1, g_loss2] = self.generator.train_on_batch(x1_batch,[x2_batch, y_batch])
                    else:
                        [g_loss, g_loss1, g_loss2] = self.generator.train_on_batch(x1_batch,[y_batch, y_batch])
