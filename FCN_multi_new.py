...
class SR_UnetGAN():
    def __init__(self):
        ...
        self.save_dir = '/media/data/fanxuan/result/FCN_compare_1'
    ...
    def build_generator(self):
        with mirrored_strategy.scope():
            ...
            model.compile(loss="mse", optimizer=self.common_optimizer)
        # model.summary()
        return model
        ...
        with tf.Session(graph=tf.get_default_graph(), config=config) as sess:
            ...
            for epoch in range(1, self.epochs+1):
                ...
                # number_of_batches
                    ...
                    g_losses = mirrored_strategy.experimentaxl_run(self.generator.train_on_batch, (x_batch, y_batch))
                    g_loss = mirrored_strategy.reduce(tf.distribute.ReduceOp.MEAN, g_losses, axis=None)
