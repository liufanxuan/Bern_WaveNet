...
class SR_UnetGAN():
    def __init__(self):
        self.data_path = '/media/data/fanxuan/data/data_h5data/data_ori_uExplorer.h5'
        self.test_data_path = '/media/data/fanxuan/data/data_h5data/data_ori_test.h5'
        #data_Siemens_wave_50_bior3_7_3d.h5
        self.save_dir = '/media/data/fanxuan/result/FCN_ori_uExplorer'
    ...
    def train(self):
        ...
        with tf.Session(graph=tf.get_default_graph(), config=config) as sess:
            ...
            self.generator.load_weights('/media/data/fanxuan/result/FCN_ori_Subject/model/generator_epoch_2.hdf5')
