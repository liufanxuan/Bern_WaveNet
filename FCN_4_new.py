...
class SR_UnetGAN():
    def __init__(self):
        ...
        self.save_dir = '/media/data/fanxuan/result/FCN_multi_3_10_new'
    ...
    def train(self):
        ...
        with tf.Session(graph=tf.get_default_graph(), config=config) as sess:
            ...
            self.generator.load_weights('/media/data/fanxuan/result/FCN_multi_3_10/model/generator_epoch_185.hdf5')
