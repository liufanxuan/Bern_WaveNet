...
class SR_UnetGAN():
    def __init__(self):
        self.data_path = '/media/data/fanxuan/data/data_h5data/data_wave_Subject.h5'
        self.test_data_path = '/media/data/fanxuan/data/data_h5data/data_wave_test_uexplorer_224.h5'
        self.test_data_path2 = '/media/data/fanxuan/data/data_h5data/data_wave_test_real_224.h5'
        self.test_data_path3 = '/media/data/fanxuan/data/data_h5data/data_wave_test_subject_224.h5'
        #data_Siemens_wave_50_bior3_7_3d.h5
        self.save_dir = '/media/data/fanxuan/result/FCN_multiwave_Subject'
        #self.model_path = '/media/data/fanxuan/result/FCN_multi_4/model/generator_epoch_26.hdf5'
        self.img_shape = (8,224,224,16)
        ...
        self.generator_parallel = multi_gpu_model(self.generator,4)
